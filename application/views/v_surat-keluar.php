<div class="content-wrapper">
            <div class="page-heading">
                ...
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><i class="fa fa-envelope"></i> Data Surat Keluar</li>
                </ol>
            </div>
                        ...
                        <table class="table table-striped table-bordered table-hover" id="example-table" cellspacing="0" width="100%">
                            ...
                            <?php $no=1; foreach($surat as $data){ ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo base_url(); ?>suratkeluar/show/<?php echo $data->id_surat; ?>" class="btn btn-info btn-xs">Detail</a>
                                ...
                                <div class="modal fade" id="hapussurat<?php echo $data->id_surat; ?>">
                                    ...
                                    <form action="<?php echo base_url(); ?>suratkeluar/delete" method="post">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            Apakah anda yakin akan menghapus data surat keluar berikut ?
                                        </div>
                                ...
                                <div class="modal fade" id="editsurat<?php echo $data->id_surat; ?>">
                                    ...
                                    <div class="modal-content">
                                    <form action="<?php echo base_url(); ?>suratkeluar/edit" method="post" enctype="multipart/form-data">
...
<div class="modal fade" id="modal-lg">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
          <form action="<?php echo base_url(); ?>suratkeluar/create" method="post" enctype="multipart/form-data">
            <div class="modal-header" style="background-color: #374f65; color: white;">
...
<?php }else if($this->session->flashdata('message') == 'error') { ?>
    swal("Berhasil","Data surat keluar gagal ditambahkan","error");
<?php } ?>

<?php if($this->session->flashdata('message2') == 'successfull') { ?>
    swal("Berhasil","Data surat keluar berhasil diubah","success");
<?php }else if($this->session->flashdata('message2') == 'error') { ?>
    swal("Berhasil","Data surat keluar gagal diubah","error");
<?php } ?>

<?php if($this->session->flashdata('message3') == 'successfull') { ?>
    swal("Berhasil","Data surat keluar berhasil dihapus","success");
<?php }else if($this->session->flashdata('message3') == 'error') { ?>
    swal("Berhasil","Data surat keluar gagal dihapus","error");
<?php } ?>
</script>