<div class="content-wrapper">
            <div class="page-heading">
                <h1 class="page-title">Laporan Surat Masuk</h1>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><i class="fa fa-print"></i> Data Laporan Surat Masuk</li>
                </ol>
            </div>
            <form class="form-inline float-sm-right" method="post" action="<?php echo base_url(); ?>laporan/laporansuratmasuk">
